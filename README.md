...
- feat: auto-fail on stagnation loops and verify task completion
- fix: agent survives WebSocket disconnect and allows re-attach
...
- feat: auto-fail on stagnation loops and verify task completion
- fix: agent survives WebSocket disconnect and allows re-attach
- refactor: decouple task knowledge from individual tasks

- [Download SillyAgent-0.1.0-arm64.dmg](https://github.com/wanming/SillyAgent-Releases/releases/download/v0.0.2/SillyAgent-0.1.0-arm64.dmg)
...
- fix: agent survives WebSocket disconnect and allows re-attach
- refactor: decouple task knowledge from individual tasks
- feat: add task completion intelligence with vector search and lesson tracking
- feat: add unsupported-task detection for real-time games
- feat: add evaluation framework with LLM-as-judge scoring

- [Download SillyAgent-0.1.0-arm64.dmg](https://github.com/wanming/SillyAgent-Releases/releases/download/v0.0.1/SillyAgent-0.1.0-arm64.dmg)
- [Download SillyAgent-0.1.0.dmg](https://github.com/wanming/SillyAgent-Releases/releases/download/v0.0.1/SillyAgent-0.1.0.dmg)
